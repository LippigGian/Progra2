...
import linkedBrowserModule.NavegadorEnlazado;
import stackModule.MyLinkedStack;
import stackModule.MyStack;

/** Pruebas sin dependencias externas. Ejecutar con java -cp out LinkedBrowserStackTest. */
public class LinkedBrowserStackTest {
    public static void main(String[] args) {
        ...
        NavegadorEnlazado browser = new NavegadorEnlazado();
        ...
        try (Scanner input = new Scanner("2\n3\nabc\n-1\n\n1\n   \n1\nA\n1\nB\n2\n3\n0\n");
            ...
            new LinkedBrowserExercise(input).run();
        } finally {
