...
public class LinkedBrowserExercise extends Exercise {

    private final NavegadorEnlazado navegador = new NavegadorEnlazado();

    public LinkedBrowserExercise(Scanner scanner) {
        super(scanner);
    }

    @Override
    protected void exerciseLogic() {
        System.out.println("\n===== TP 04: HISTORIAL DE NAVEGADOR WEB (NODOS) =====");
